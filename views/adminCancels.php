...
$sql = mysqli_query($conn,"SELECT * FROM cancelletions WHERE bId ='$bus'");
...
<body>
    <div class="admin-seats">
      <div class="seats-header">
         ...
         <li><button class="add-user"> + Add</button></li>
    ...
    <div class="seats-table">
        ...
        <table> 
            <tr ><th>Email</th><th>Route</th><th>date</th><th>Seat</th><th>Ticket</td><th>Price</td><th>Action</td></tr><br><br>
             
           
             <?php foreach($users as $user) :?>
          

    <tr><td><?php echo  $user['email'] ?></td><td><?php echo $user['route'] ?></td><td><?php echo $user['date'] ?></td><td><?php echo $user['seatno'] ?></td><td><?php echo $user['ticket'] ?></td><td><?php echo $user['price'] ?></td><td><button><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button></td></tr>
